package com.example.alarmproject.nevigation;
...
import com.example.alarmproject.AddAlarmActivity;
import com.example.alarmproject.AlarmData;
import com.example.alarmproject.R;
import com.example.alarmproject.database.AlarmListAdapter;
...
public class ListFragment extends Fragment  implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        alarmList = db.getAllAlarmDatas();

        btnAdd.setOnClickListener(this);


        adapter = new AlarmListAdapter(getActivity(),alarmList);
